...
{
//加装云台参数
k[0][0] = -3.8563f * t3 + 93.7342f * t2 + -97.4570f * t1 + -1.3982f;
k[0][1] = 16.1516f * t3 + -11.3930f * t2 + -5.2875f * t1 + -0.0300f;
k[0][2] = 3.3259f * t3 + 3.9336f * t2 + -5.9340f * t1 + -0.0455f;
k[0][3] = 7.4965f * t3 + 5.6483f * t2 + -10.2671f * t1 + -0.4000f;
k[0][4] = 370.7311f * t3 + -304.7309f * t2 + 13.4700f * t1 + 40.6845f;
k[0][5] = -7.2771f * t3 + 11.7712f * t2 + -9.4262f * t1 + 3.9453f;
k[1][0] = 1672.8282f * t3 + -1478.1772f * t2 + 180.6148f * t1 + 145.2644f;
k[1][1] = 134.1358f * t3 + -151.3086f * t2 + 43.2800f * t1 + 9.1675f;
k[1][2] = 130.2392f * t3 + -107.4012f * t2 + 5.5905f * t1 + 13.7151f;
k[1][3] = 83.0861f * t3 + -30.1637f * t2 + -53.7981f * t1 + 34.8059f;
k[1][4] = -228.9105f * t3 + -1056.8961f * t2 + 1175.5487f * t1 + -14.3436f;
k[1][5] = 88.5774f * t3 + -140.6696f * t2 + 82.8157f * t1 + -6.1046f;
