...
{
k[0][0] = -27.9651f * t3 + 107.1848f * t2 + -97.8044f * t1 + 1.0429f;
k[0][1] = 20.3324f * t3 + -17.2252f * t2 + -2.7908f * t1 + 0.0820f;
k[0][2] = -2.4143f * t3 + 19.1291f * t2 + -16.2835f * t1 + 0.7451f;
k[0][3] = -1.0378f * t3 + 18.1606f * t2 + -16.8218f * t1 + 0.5381f;
k[0][4] = 349.8856f * t3 + -277.9332f * t2 + 19.3770f * t1 + 31.4584f;
k[0][5] = 10.0730f * t3 + -5.7072f * t2 + -3.9695f * t1 + 3.9138f;
k[1][0] = 1450.3005f * t3 + -1367.3829f * t2 + 316.3485f * t1 + 57.9776f;
k[1][1] = 102.3650f * t3 + -126.6493f * t2 + 50.3978f * t1 + 1.2276f;
k[1][2] = 266.1422f * t3 + -211.2545f * t2 + 16.2336f * t1 + 22.1341f;
k[1][3] = 154.0031f * t3 + -94.0744f * t2 + -27.8011f * t1 + 29.4897f;
k[1][4] = 596.9543f * t3 + -1615.1669f * t2 + 1150.7245f * t1 + -75.6584f;
k[1][5] = 66.5210f * t3 + -153.5316f * t2 + 107.2907f * t1 + -12.6404f;
