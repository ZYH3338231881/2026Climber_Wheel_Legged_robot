 ...
 void GetK(float l, float k[2][6], bool is_take_off)
{
    ...
    float t3 = l * l * l;
	//参数从matlab中导出
k[0][0] = -51.1796f * t3 + 111.6564f * t2 + -88.5101f * t1 + -0.7930f;
k[0][1] = 11.7619f * t3 + -9.5355f * t2 + -3.9252f * t1 + -0.0247f;
k[0][2] = -3.2534f * t3 + 7.8260f * t2 + -5.4525f * t1 + 0.1639f;
k[0][3] = -5.9108f * t3 + 16.0908f * t2 + -11.9932f * t1 + 0.2799f;
k[0][4] = 131.2511f * t3 + -94.6047f * t2 + -6.5995f * t1 + 19.6539f;
k[0][5] = 3.5401f * t3 + 0.2361f * t2 + -4.6905f * t1 + 3.2526f;
k[1][0] = 953.6040f * t3 + -938.2029f * t2 + 254.0273f * t1 + 27.3002f;
k[1][1] = 45.1890f * t3 + -55.3510f * t2 + 21.4738f * t1 + 2.9283f;
k[1][2] = 49.3455f * t3 + -36.9388f * t2 + -0.1538f * t1 + 5.9186f;
k[1][3] = 93.7497f * t3 + -66.5269f * t2 + -5.5922f * t1 + 14.0826f;
k[1][4] = 438.6677f * t3 + -798.2882f * t2 + 493.8705f * t1 + -26.9546f;
k[1][5] = 70.0831f * t3 + -115.9298f * t2 + 69.2092f * t1 + -6.8245f;
