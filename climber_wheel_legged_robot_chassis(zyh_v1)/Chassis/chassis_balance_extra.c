 ...
 void GetK(float l, float k[2][6], bool is_take_off)
{
    ...
    float t3 = l * l * l;
	//参数从matlab中导出
k[0][0] = -31.6870f * t3 + 95.1989f * t2 + -82.7317f * t1 + -0.8476f;
k[0][1] = 12.0962f * t3 + -9.2004f * t2 + -3.6228f * t1 + -0.0018f;
k[0][2] = -1.3447f * t3 + 7.0563f * t2 + -5.8557f * t1 + 0.2073f;
k[0][3] = -1.2608f * t3 + 11.0632f * t2 + -9.9849f * t1 + 0.2808f;
k[0][4] = 219.3397f * t3 + -170.6477f * t2 + 3.7026f * t1 + 25.1102f;
k[0][5] = 4.5329f * t3 + -0.5611f * t2 + -5.0703f * t1 + 3.6347f;
k[1][0] = 1240.5266f * t3 + -1223.3471f * t2 + 328.3785f * t1 + 29.3321f;
k[1][1] = 63.2557f * t3 + -74.1958f * t2 + 25.5060f * t1 + 3.5950f;
k[1][2] = 80.4649f * t3 + -63.6025f * t2 + 3.3118f * t1 + 7.9085f;
k[1][3] = 116.1914f * t3 + -87.5245f * t2 + -1.7433f * t1 + 14.7956f;
k[1][4] = 366.6979f * t3 + -1017.2964f * t2 + 743.2207f * t1 + -40.3827f;
k[1][5] = 52.9696f * t3 + -118.0190f * t2 + 82.3114f * t1 + -8.7545f;
