...
{
k[0][0] = -61.6026f * t3 + 145.3843f * t2 + -112.3985f * t1 + 2.9735f;
k[0][1] = 20.2421f * t3 + -16.6197f * t2 + -3.2319f * t1 + 0.2064f;
k[0][2] = -14.7685f * t3 + 32.4110f * t2 + -21.0722f * t1 + 1.3178f;
k[0][3] = -16.1494f * t3 + 34.1492f * t2 + -22.5078f * t1 + 1.2213f;
k[0][4] = 398.0085f * t3 + -313.6917f * t2 + 25.9130f * t1 + 31.3961f;
k[0][5] = 19.5805f * t3 + -14.5310f * t2 + -1.3646f * t1 + 3.6796f;
k[1][0] = 1598.0302f * t3 + -1486.6296f * t2 + 344.9653f * t1 + 55.3249f;
k[1][1] = 129.9150f * t3 + -154.9394f * t2 + 60.8439f * t1 + -0.4934f;
k[1][2] = 291.1670f * t3 + -227.0628f * t2 + 17.4637f * t1 + 22.5022f;
k[1][3] = 183.4881f * t3 + -114.5789f * t2 + -24.6663f * t1 + 29.4957f;
k[1][4] = 1284.2723f * t3 + -2359.1362f * t2 + 1420.5478f * t1 + -108.0119f;
k[1][5] = 99.0927f * t3 + -194.6770f * t2 + 124.8410f * t1 + -15.1782f;
