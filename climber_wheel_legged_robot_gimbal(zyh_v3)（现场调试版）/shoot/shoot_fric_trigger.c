...
extern MTOC_message_t mtoc_mzesasge;
...
{
		if(((visionDataStu.mode == 1||visionDataStu.mode==2)&&mtoc_mesasge.mouse_press_l && mtoc_mesasge.mouse_press_r)||(mtoc_mesasge.mouse_press_l==1&&mtoc_mesasge.mouse_press_r!=1))
		{
			  if(mtoc_mesasge.power_heat<(mtoc_mesasge.shoot_heat_limit-50))
				{
					SHOOT.REF.trigger_speed_ref = TRIGGER_SPEED;
				}
				else if(mtoc_mesasge.power_heat<(mtoc_mesasge.shoot_heat_limit-30))
				{
					SHOOT.REF.trigger_speed_ref = TRIGGER_SPEED-300;
				}
				else
				{
		...
		else if(mtoc_mesasge.trigger_flag==1)
		{
			SHOOT.REF.trigger_speed_ref=300;  
		}
		else if(mtoc_mesasge.trigger_flag==2)
		{
			SHOOT.REF.trigger_speed_ref=400;  
		}
		else if(mtoc_mesasge.trigger_flag==3)
		{
			SHOOT.REF.trigger_speed_ref=200;  
		}
		else
		{
				SHOOT.REF.trigger_speed_ref = 0;
