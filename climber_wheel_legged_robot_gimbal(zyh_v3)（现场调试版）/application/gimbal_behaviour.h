...
//YAW ANGLE
#define KP_GIMBAL_YAW_ANGLE (20)//150
#define KI_GIMBAL_YAW_ANGLE (0)
#define KD_GIMBAL_YAW_ANGLE (0.05)//70
#define MAX_IOUT_GIMBAL_YAW_ANGLE (0)
#define MAX_OUT_GIMBAL_YAW_ANGLE (8)
//VELOCITY:角速度
#define KP_GIMBAL_YAW_VELOCITY (1)//1200
#define KI_GIMBAL_YAW_VELOCITY (0)
#define KD_GIMBAL_YAW_VELOCITY (0.05)
#define MAX_IOUT_GIMBAL_YAW_VELOCITY (0)
#define MAX_OUT_GIMBAL_YAW_VELOCITY (7)


//YAW ANGLE
#define KP_GIMBAL_YAW_ANGLE_4310 (2)//150
...
//VELOCITY:角速度
#define KP_GIMBAL_YAW_VELOCITY_4310 (1)//1200
#define KI_GIMBAL_YAW_VELOCITY_4310 (0)
#define KD_GIMBAL_YAW_VELOCITY_4310 (0.05)
...
#define KD_GIMBAL_PITCH_ANGLE (0.1)       //  位置稳态，过多可能冲过头
#define MAX_IOUT_GIMBAL_PITCH_ANGLE (2)
#define MAX_OUT_GIMBAL_PITCH_ANGLE (8)  //在速度单环pid下实际可能出现的最大转速
//VELOCITY:角速度
