...
2/26：解决键鼠造成速度徒增的问题 采用控制加速的方式来响应速度,十分缓解了由于速度徒增导致翻车问题。
...
3.19： 修改完速度反馈观测，加入腿部摆角反馈，让车子的鲁棒性有了巨大的提高，同时融入了速度-加速度的卡尔曼滤波极大的解决了打滑问题。
    参考：https://zhuanlan.zhihu.com/p/689921165

3.10:增加了云台速控，失控检测（但是还未测试）
## 项目结构
